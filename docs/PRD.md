...
| 功能 | 说明 |
|------|------|
| **认证系统** | 当前生产入口为邮箱注册/登录；Google/GitHub 快捷登录暂不开放 |
| **通用8D表单** | 仅1个通用模板，完整D0-D8 |
| **PDF导出** | 报告导出为PDF |
| **报告列表 + 查看** | 个人报告列表 |
| **分享链接** | 只读分享链接 |
| **基础定价** | 免费版5份 lifetime reports（PDF带水印），Pro版$9.99/月（无限无水印） |
...
- Free 用户**创建报告即消耗 1 份额度**
- 第 6 份报告需要升级 Pro
- 已有报告在额度用完后仍可继续查看、编辑和导出
...
| 认证 | 登录、注册、忘记密码 | 当前为邮箱注册/登录；Google/GitHub 快捷登录暂不开放 |
| 仪表盘 | 报告列表 | 个人报告列表 |
