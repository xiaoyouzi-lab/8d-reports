    ...
    <div className="bg-white font-sans">
        ...
        <div className="mx-auto grid max-w-6xl gap-10 px-4 sm:px-6 lg:grid-cols-[0.92fr_1.08fr] lg:items-start">
          <div>
            ...
            <div className="mt-8 space-y-3 text-sm text-slate-700">
              <div className="flex gap-3"><CheckCircle2 className="mt-0.5 size-4 shrink-0 text-emerald-600" /> 先执行确定性规则，再由 AI 解释或改写</div>
      ...
      <section className="py-16">
        <div className="mx-auto max-w-4xl px-4 sm:px-6">
          <h2 className="text-2xl font-semibold tracking-tight text-slate-950">完整审查会逐项挑战什么</h2>
          ...
          <div className="mt-10 rounded-xl border border-slate-200 bg-slate-50 p-5 text-sm leading-6 text-slate-700">
            <span className="font-semibold text-slate-950">Complete Rejection Risk Review：每份 39 美元。</span>{" "}
            一次性购买，包含完整逐项分析、应补事实、客户可能追问、基于已知事实的英文改写和可下载审查包。不承诺客户必然接受、合规通过、根因已确认或措施已证明有效。
          </div>
