  ...
  await db.insert(plans).values([
    {
      ...
      name: "Free",
      description: "3 reports, watermarked PDF",
      priceMonthly: "0",
      priceYearly: "0",
      reportsPerMonth: 3,
      maxTeamMembers: 1,
    ...
    {
      creemProductId: "plan_team_monthly",
      name: "Team Monthly",
      description: "5 seats, shared workspace, unlimited reports",
      priceMonthly: "99.00",
      priceYearly: null,
      reportsPerMonth: -1,
      maxTeamMembers: 5,
      features: ["all_templates", "unlimited_photos", "pdf_export_no_watermark", "word_export", "company_logo", "editable_share", "deep_search", "team_workspace"],
    },
  ]);
