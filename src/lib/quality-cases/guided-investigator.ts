...
const STAGE_MISSING_CONCEPTS: Record<GuidedStage, readonly QualityConcept[]> = {
  problem_description: [
    "problem_symptom",
    "problem_scope",
    "problem_discovery",
