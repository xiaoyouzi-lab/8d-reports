...
assert.match(revenueGeoRoute, /canonical: url/, "Revenue GEO resource route should set canonical URLs");
assert.match(revenueGeoRoute, /"zh-CN": zhUrl/, "Revenue GEO resource route should link to its zh-CN alternate");
